...
offckb deploy --network devnet --target <contract-binary-path> --output /Volumes/workspack/code/ckb/crowdfunding/deployment
```
...
```bash
# Deploy to testnet
offckb deploy --network testnet --target <contract-binary-path> --output /Volumes/workspack/code/ckb/crowdfunding/deployment
```
