  ...
  return (
    <>
      <div className="text-xs text-muted-foreground mt-4">
        claimScript:{getContractConfig(getNetwork()).claimScript?.codeHash}
      </div>
      <div className="text-xs text-muted-foreground mt-4">
        contributionScript:
        {getContractConfig(getNetwork()).contributionScript?.codeHash}
      </div>
      <div className="text-xs text-muted-foreground mt-4">
        projectScript:{getContractConfig(getNetwork()).projectScript?.codeHash}
      </div>
      <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
        <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
          <p className="text-2xl font-bold animate-bounce">
            Well done! You can now cook up CKB dApp with{' '}
            <span className="text-cyan-600">CCC</span>!!!
          </p>
          <Image
          ...
          <div className="flex flex-col gap-3 items-center w-full">
            ...
            <div className="flex flex-col gap-2 items-start">
              ...
              <li>
                Empower yourself with CCC to discover the unlimited potential of
                CKB.
              </li>
              <li>
              ...
              <li>
                Fully enabling CKB's Turing completeness and cryptographic
                freedom power.
              </li>
            </div>
          </div>
